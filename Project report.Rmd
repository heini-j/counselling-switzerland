...
The data was visualised on a map to assess whether different areas have equal access to psychological counseling. This involved finding the right geodata for Switzerland with the unit of the analysis: postcode areas. This data was found from City of Luzern's data portal and downloaded on the computer as a shapefile.
...
Using the population data and the data on number of psychologist was visualised on a separate map. This map shows the number of people, or potential clients, per psychologist in each zipcode.
